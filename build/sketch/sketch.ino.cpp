...
const char* ssid = "LME";
const char* password = "eminescu17";
...
#line 30 "/workspaces/M5TallyServer/sketch/sketch.ino"
void setup();
#line 100 "/workspaces/M5TallyServer/sketch/sketch.ino"
void sendStatusUpdate();
#line 119 "/workspaces/M5TallyServer/sketch/sketch.ino"
void checkForUdpMessages();
#line 143 "/workspaces/M5TallyServer/sketch/sketch.ino"
void loop();
#line 30 "/workspaces/M5TallyServer/sketch/sketch.ino"
void setup() {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    ...
    AtomS3.Lcd.fillScreen(TFT_BLACK);
    AtomS3.Display.drawString(String(blable++), AtomS3.Display.width() / 2, AtomS3.Display.height() / 2);
  }
  ...
  // Wait for a moment to let the display update
  delay(2000);
